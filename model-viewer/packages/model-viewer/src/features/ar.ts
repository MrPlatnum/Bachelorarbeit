...
export const ARMixin = <T extends Constructor<ModelViewerElementBase>>(
  ...
  class ARModelViewerElement extends ModelViewerElement {
    ...
    @property({type: Number, attribute: 'ar-vertical-offset'})
    arVerticalOffset: number = 0;
    ...
    update(changedProperties: Map<string, any>) {
      ...
      if (changedProperties.has('arVerticalOffset')) {
        this[$renderer].arRenderer.setVerticalOffset(this.arVerticalOffset);
      }
